      ...
      <div className={styles.home}>
        <div className={styles.left}>
          <div className={styles.left_top}>
            <EditProfileIcon className={styles.edit_profile_icon} width="1em" height="1em" />
            ...
            <div className={styles.profile_icons}>
              <LinkedinIcon width="1.2em" height="1.2em" />
              <EmailIcon width="1.2em" height="1.2em" />
            </div>
          </div>
          <div className={styles.left_bottom}>
            ...
            <hr className={styles.line}></hr>
            <div className={styles.filter_item}>
              <TickIcon className={styles.tick_icon} width="0.8em" height="0.8em" color="#DCDCDC" />
